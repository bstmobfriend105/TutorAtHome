...
static  NSString *const sLoadAWSCourseware          = @"LoadAWSCourseware";
...
static  NSString *const sFileData                   = @"filedata";
...
static  NSString *const sCurrPage                   = @"currpage";
static  NSString *const sPageNum                    = @"pagenum";
static  NSString *const sCourseWare                 = @"courseware";
static  NSString *const sSwfPath                    = @"swfpath";
static  NSString *const sClearDrawing               = @"cleardrawing";
